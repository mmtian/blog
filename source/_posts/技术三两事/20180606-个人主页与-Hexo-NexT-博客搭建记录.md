...
因为目前的个人主页与博客都放在了 [Netlify](https://www.netlify.com) 上面，由 Netlify 获取 GitHub 对应的项目仓库内容自动进行网站页面生成与部署。所以直接在 Netlify 对应的项目中添加好域名，再根据提示去设置解析。
...
{% note info %}
**提示：** 这部分介绍的是 [旧版学术主页](https://github.com/dongleizhang/old-academic-homepage) 的内容，[目前学术主页](https://github.com/dongleizhang/dongleizhang.github.io) 已采用基于 Hexo NexT 主题。
{% endnote %}
