...
{% img /cloud/posts/2018/20180606/dns.png 600 Cloudflare DNS 设置 %}
...
{% note info %}
**提示：** 这部分介绍的是 [旧版学术主页](https://github.com/lei2rock/old-academic-homepage) 的内容，[目前学术主页](https://github.com/lei2rock/dongleizhang.github.io) 已采用基于 Hexo NexT 主题。
{% endnote %}
...
```
{% img /cloud/posts/2018/20180606/tagicon.png 600 文章标签图标 %}
...
这样，就会有下图这样的效果了：
{% img /cloud/posts/2018/20180606/pintop.png 600 文章置顶 %}
